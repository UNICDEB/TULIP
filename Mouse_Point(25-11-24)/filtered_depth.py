...
#     # color_sensor.set_option(rs.option.exposure,30)
...
#             # x, y, z = round(d_point[0],4),round( d_point[1],4),round( d_point[2],4)
#             x, y, z = round(d_point[0],4),round( (d_point[1]*2),2),round( (d_point[2]*1000),2)
#             cv2.circle(color_image, (point[0],point[1]), 8, (0, 0, 255),-1)
#             # print(" point {} and {} has cooridnate {}, {} ,{} m".format(point[0],point[1],x,y,z))
...
#                 # l.append(y)
#                 # l.append(z)
#                 cv2.circle(color_image, (point[0],point[1]), 8, (68, 247, 11),-1)
#                 print("Inside ")
#                 print(x,y,z)
